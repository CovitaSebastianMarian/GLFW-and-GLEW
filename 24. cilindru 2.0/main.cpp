...
int main() {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        fd = CreateForm(sze, hsze, jump);
        circle.Reload(fd.positions, sizeof(fd.positions), fd.indices, sizeof(fd.indices));
        ...
        circle.Bind(GL_TRIANGLES, fd.indices_size, GL_UNSIGNED_INT, 0);
