...
int main() {
    ...
    for (int i = 0; i < model.KitVector.size(); ++i) {
        ...
        obj[i].LookAt(glm::vec3(0, 2, 5), glm::vec3(0, 0, 1), glm::vec3(0, 1, 0));
        obj[i].Scale(glm::vec3(100, 100, 100), false);


        obj[i].setVec("light.lightPos", 0, 3, 3);
        obj[i].setVec("light.lightColor", 1, 1, 1);
        obj[i].setVec("light.viewPos", obj[i].Camera.eye.x, obj[i].Camera.eye.y, obj[i].Camera.eye.z);

        
        obj[i].setVec("material.ambient", Material.black_rubber.ambient);
        obj[i].setVec("material.diffuse", Material.black_rubber.diffuse);
        obj[i].setVec("material.specular", Material.black_rubber.specular);
        obj[i].setVec("material.shininess", Material.black_rubber.shininess);
    }
